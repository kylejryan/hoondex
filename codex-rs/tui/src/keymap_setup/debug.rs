...
const SHORT_MISSING_KEY_HINT: &str = "Tip: Hoondex can only inspect keys your terminal sends.";
const DELAYED_MISSING_KEY_HINT: &str = "Still waiting? If nothing changes when you press a key, your terminal is not sending that key to Hoondex. Only received keys can be assigned as shortcuts.";
