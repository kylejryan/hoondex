...
const HOONIFY_PROVIDER_NAME: &str = "Hoonify";
pub const HOONIFY_PROVIDER_ID: &str = "hoonify";
pub const HOONIFY_DEFAULT_BASE_URL: &str = "https://api.hoonify.ai/v1";
pub const HOONIFY_ENV_KEY: &str = "HOONIFY_API_KEY";
pub const HOONIFY_DEEPSEEK_MODEL_ID: &str = "deepseek-ai/DeepSeek-V4-Pro";
...
pub enum WireApi {
    ...
    /// Used by OpenAI-compatible third-party providers (for example Hoonify).
    Chat,
}
...
impl ModelProviderInfo {
    ...
    /// Hoonify: OpenAI-compatible Chat Completions gateway authenticated with a bearer
    /// `HOONIFY_API_KEY`. See <https://api.hoonify.ai/v1/chat/completions>.
    pub fn create_hoonify_provider() -> ModelProviderInfo {
        ModelProviderInfo {
            name: HOONIFY_PROVIDER_NAME.into(),
            base_url: Some(HOONIFY_DEFAULT_BASE_URL.into()),
            env_key: Some(HOONIFY_ENV_KEY.into()),
            env_key_instructions: Some(format!(
                "Create an API key on the Hoonify dashboard and export it as `{HOONIFY_ENV_KEY}`."
            )),
            experimental_bearer_token: None,
            auth: None,
            aws: None,
...
pub fn built_in_model_providers(
    ...
    [
        (HOONIFY_PROVIDER_ID, P::create_hoonify_provider()),
