# Hoondex Python SDK (Beta)

Build Python applications that start Hoondex threads, run turns, stream progress,
...
The SDK reuses your existing Hoondex authentication when one is already
available:
...
Existing Hoondex authentication is reused automatically. To start ChatGPT
...
Use Python's standard `help(openai_codex)`, `help(Hoondex)`, or
